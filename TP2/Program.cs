...
namespace TP2
{
    class GestorCotizacion
    {
        ...
        {
            //Qué quiere hacer el cliente según opciones disponibles
            var decision= "0";
            while(decision!="3")
            {
                ...
                //Si no ha seleccionado opciones válidas, repetir pregunta
                ...
                //Op 1 --> Crear cotización
                if(decision=="1")
                {
                    //Si no hay clientes, pedir registrar cliente
